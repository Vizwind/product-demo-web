    ...
    <fieldset v-else class="form-group">
      ...
      <form v-on:submit.prevent="onSubmit">
        <div v-bind:class="{ 'has-danger': indexedErrors.lastName }" class="form-group">
          ...
          <input type="text" v-focus name="lastName" id="inputLastName" v-model="product.lastName" class="form-control form-control-danger" />
        ...
        <div v-bind:class="{ 'has-danger': indexedErrors.firstName }" class="form-group">
          ...
          <input type="text" name="firstName" id="inputFirstName" v-model="product.firstName" class="form-control form-control-danger" />
        ...
        <div v-bind:class="{ 'has-danger': indexedErrors.email }" class="form-group">
          ...
          <input type="text"c name="email" id="inputEmail" v-model="product.email" class="form-control form-control-danger" />
        ...
        <div v-bind:class="{ 'has-danger': indexedErrors.phone }" class="form-group">
          ...
          <input type="tel" name="phone" id="inputPhone" v-model="product.phone" class="form-control form-control-danger" />
